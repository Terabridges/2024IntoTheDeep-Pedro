...
public class AutoPositionsNet
{
    ...
    public final Pose preloadPose = new Pose(35, 80.5, Math.toRadians(180));

    public final Pose scorePose = new Pose(16, 128, Math.toRadians(135));

    /* Lowest (First) Sample from the Spike Mark */
    public final Pose pickup1Pose = new Pose(45.75, 102, Math.toRadians(90));
    //Control pose for curve
    public final Pose pickup1ControlPose = new Pose(35, 95, Math.toRadians(90));
