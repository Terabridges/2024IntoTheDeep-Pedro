...
public class AutoObservationZone extends OpMode
{
    ...
    public AutoPositionsObservation o;
    ...
    public void buildPaths()
    {
         ...
         */
        o.park = follower.pathBuilder()
                .addPath(new BezierLine(new Point(o.startPose), new Point(o.parkPose)))
                .setLinearHeadingInterpolation(o.startPose.getHeading(), o.parkPose.getHeading())
                .build();
    }
    ...
    public void autonomousPathUpdate()
    {
        ...
        switch (pathState)
        {
            ...
            case PARK:
                ...
                {
                    follower.followPath(o.park);

                    pathState = PathState.END;
                }
                break;
            case END:
                if(follower.getPose().getX() > (o.parkPose.getX() - 1) && follower.getPose().getY() > (o.parkPose.getY() - 1))
                {
...
//        telemetry.addData("heading", Math.toDegrees(follower.getPose().getHeading()));
    ...
    public void init() {
        ...
        o = new AutoPositionsObservation();
        ...
        follower.setMaxPower(o.pedroSpeed);
